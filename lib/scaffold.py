...
'''
    scaffold.py
    BYU Configurable Computing Lab (CCL): BFAT project, 2023

    Provides functions for reading from and writing to files in the
    provided directory scaffold for organization.
'''
